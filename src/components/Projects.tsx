...
type ProjectStatus = 'All' | 'In Development' | 'ML/AI';
...
const projects: Project[] = [
  ...
  },
  {
    ...
    tech: ['Python', 'Flask', 'Scikit-Learn', 'Pandas', 'NumPy', 'GradientBoosting'],
    github: 'https://github.com/premraj-dev/NutriCore_AI',
    demo: 'https://nutricore-iui0.onrender.com',
  },
  {
...
const FILTERS: ProjectStatus[] = ['All', 'In Development', 'ML/AI'];
              ...
              {filtered.map((project) => (
                ...
                >
                  ...
                  <div className="flex gap-3 pt-2 border-t border-black/5">
                    {project.github && (
                      <a href={project.github} target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-black transition-colors" aria-label="GitHub">
                        <Github size={18} />
                      </a>
                    )}
                    {project.demo && (
                      <a href={project.demo} target="_blank" rel="noopener noreferrer" className="text-text-secondary hover:text-black transition-colors" aria-label="Live Demo">
